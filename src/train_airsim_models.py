...
from training_configs import AirsimConfig

for dataset in AirsimConfig.datasets:
    for checkpoint in AirsimConfig.checkpoints:
        ...
        train_base_model(
            ...
            id2label=AirsimConfig.id2label,
            label2id=AirsimConfig.label2id,
